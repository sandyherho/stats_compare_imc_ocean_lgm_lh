...
def main():
    ...
    # Adjust spacing to make room for legend at bottom
    plt.subplots_adjust(hspace=0.35, wspace=0.3, bottom=0.12)
    
    # Store handles and labels for legend (we'll get them from first plot)
    legend_handles = []
    legend_labels = []
    ...
    line_lgm, = ax.plot(x_grid, kde_lgm, color=color_lgm, linewidth=2.5, label='LGM')
    line_lh, = ax.plot(x_grid, kde_lh, color=color_lh, linewidth=2.5, label='Late Holocene')
    ...
    legend_handles = [line_lgm, line_lh]
    legend_labels = ['LGM', 'Late Holocene']
    ...
    ax.plot(x_grid, kde_lgm, color=color_lgm, linewidth=2.5)
    ax.plot(x_grid, kde_lh, color=color_lh, linewidth=2.5)
    ax.fill_between(x_grid, kde_lgm, alpha=0.3, color=color_lgm)
    ax.fill_between(x_grid, kde_lh, alpha=0.3, color=color_lh)
    ...
    # ============================================================================
    # Add single figure-level legend at the bottom
    # ============================================================================
